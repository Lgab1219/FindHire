    ...
    <?php foreach ($applications as $application) : ?>
      <div class="post_container">
        ...
        <form method="POST" style="display:inline;">
          ...
          <button type="submit" name="action" value="accept" id="acceptButton">Accept</button>
          <button type="submit" name="action" value="reject" id="rejectButton">Reject</button>
          <a href="Messenger.php?accountID=<?php echo htmlspecialchars($application['accountID']); ?>&postID=<?php echo $postID; ?>" style="text-decoration: none;" id="sendMessageButton">Message Applicant</a>
        </form>
      </div>
